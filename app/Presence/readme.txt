 ...
 This will deploy two artifacts, target/Presence.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/Presence.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/Presence.war

 To undeploy the application, run:

  ./asadmin undeploy Presence
